...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            ...
            html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(children=R_chart4)],style={'flex': '1'})
            ]
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(Y_chart1),html.Div(Y_chart2)],style={'flex': '1'}),
                html.Div(className='chart-item', children=[html.Div(Y_chart3),html.Div(Y_chart4)],style={'flex': '1'})
                ]
